...
def make_db_lsh(db_directory_path: str, prep_dir_name: str = "prep_schemaless", **kwargs: Any) -> None:
    """
    ...
    preprocessed_path = Path(db_directory_path) / prep_dir_name
